...
class MockedQBResultsExporter():
    ...
    def get_build_test_data(self, build_id):
...
def test_quickbuild_xml_decode_success():
    ...
    results = store_results.quickbuild_xml_decode(DUMMY_BUILD_INFO_SUCCESS, qb_results_exporter, mock_logger)
    verify_results_success(results)
...
def test_quickbuild_xml_decode_failure():
    ...
    results = store_results.quickbuild_xml_decode(DUMMY_BUILD_INFO_FAILURE, qb_results_exporter, mock_logger)
    verify_results_failure(results)
